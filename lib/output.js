...
const writeFlowContents = (handle, mermaid, contents = {}) => {
  if (
    contents.content &&
...
const writeMermaid = (handle, mermaid, connections = [], processors = {}) => {
  if (connections.length) {
    ...
    handle.write(`${mermaid.replace("CONTENTS", chart)}\n\n`);
  }
};
